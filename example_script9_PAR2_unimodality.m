...
noise = 0.2; %level of noise for each dataset, for gaussian noise only!
...
constraints{2} = {'unimodality',false}; %specify constraints-regularizations for each mode, find the options in the file "List of constraints and regularizations.txt"

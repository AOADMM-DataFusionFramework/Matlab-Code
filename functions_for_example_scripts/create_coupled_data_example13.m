function  [X, A, Delta,sigma] = create_coupled_data_example13(varargin)
% CREATE_COUPLED_DATA generates coupled higher-order tensors for example script 13, with partial coupling and double sampling rate.
%      
%
...
for i=1:nb_c_modes
    ...
    switch ctype
        ...
        case 5
            ...
            A{mode1} = A{mode1}*coupl_trafo_matrices2{mode1};

%%  example script AOADMM for CMTF with Frobenius loss
...
for i=1:5
    corr(Fac.fac{i},Atrue{i})
end
%% FMS 
FMS1_AOADM = score(Zhat{1},true_ktensor{1});
FMS2_AOADMM = score(Zhat{2},true_ktensor{2});
FMStotal_AOADMM = FMS1_AOADM*FMS2_AOADMM;
